...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/07 12:49:56 by yzaoui            #+#    #+#             */
/*   Updated: 2023/12/07 12:59:48 by yzaoui           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    const char *file_path = "./Lien_symbolique_sur_Explication.md"; // Chemin de votre lien symbolique
    struct stat file_info;

    // Obtenir des informations sur le lien symbolique
